  ...
  return (
    <section className="bg-white py-12 sm:py-16 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-16">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 xl:gap-20 items-center mb-12 sm:mb-16 lg:mb-24">
          ...
          <div className="text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-gilroy-bold leading-tight">
              <span className="block text-gray-900">
                {heading.line1} <span className="text-[#ED1D25] text-4xl sm:text-5xl md:text-6xl lg:text-7xl">{heading.highlight}</span>
              </span>
          ...
          <div className="space-y-4 sm:space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start">
              <button 
                className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base md:text-lg font-medium bg-[#ED1D25] border-2 border-[#ED1D25] text-white rounded-full hover:bg-[#C91A22] transition-all w-full sm:w-auto"
                style={{ borderRadius: '100px' }}
              >
                {buttons.primary}
              </button>
              <button 
                className="px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base md:text-lg font-medium bg-white border-2 border-[#ED1D25] text-gray-900 rounded-full hover:bg-gray-50 transition-all w-full sm:w-auto"
                style={{ borderRadius: '100px' }}
              >
                {buttons.secondary}
              </button>
        ...
        <div className="bg-gradient-to-r from-[#ED1D25] to-[#991B1B] rounded-2xl overflow-visible relative">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-center px-4 sm:px-6 lg:px-8 xl:px-12 relative py-8 sm:py-12 overflow-visible">
            {/* Left Side - Dollar Background and Handyman Image */}
            <div className="relative h-48 sm:h-64 md:h-80 lg:h-96 flex items-end justify-center mt-4 sm:mt-8 lg:mt-0 order-2 lg:order-1" style={{ overflow: 'visible' }}>
              <div className="relative w-full h-full" style={{ overflow: 'visible' }}>
                {/* Dollar Background Image - Full height from top to bottom */}
                ...
                {/* Handyman Image - Above dollar background, hand overflows from top */}
            ...
            <div className="text-white space-y-4 sm:space-y-6 text-center lg:text-left order-1 lg:order-2">
              <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-gilroy-bold leading-tight" style={{ fontFamily: 'Gilroy-Bold, sans-serif' }}>
              ...
              <div className="flex justify-center lg:justify-start">
                <div
                  ...
                  style={{
                    background: 'linear-gradient(90.64deg, #6D0002 -2.57%, #ED1D25 50%, #FFFFFF 108.74%)',
                    boxShadow: '0px 4px 24px 0px rgba(255, 74, 74, 0.25), 0px 4px 34px 0px rgba(255, 0, 0, 0.25), 0px 4px 34px 0px rgba(255, 255, 255, 0.25)',
                  }}
                >
                  <button
                    className="bg-[#991B1B] rounded-[55px] text-white font-semibold text-sm sm:text-base hover:bg-[#7F1D1D] transition-all whitespace-nowrap w-full h-full"
                    style={{
                      padding: '12px 24px',
