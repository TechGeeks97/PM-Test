      ...
      <section className="bg-white py-12 sm:py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-4">
            <p className="text-[var(--color-primary)] text-base sm:text-lg md:text-xl font-medium mb-2">
              {subtitle}
            </p>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-gilroy-bold text-gray-900 mb-2">
              {heading}
            </h2>
          </div>
        </div>
