...
export const DailyUpdates: React.FC<DailyUpdatesProps> = ({
  ...
  const articleId = "gulf-markets-mixed-ukraine-ceasefire";
  const articleUrl = `/articles/${articleId}`;

  const handlePlay = () => setIsPlaying(true);

  const getThumbnailUrl = () => {
    if (!videoUrl) return "/images/media bg-cover.png";
    ...
    <section className="bg-gray-50 py-12 sm:py-16 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="mb-8 sm:mb-12">
          <div className="mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
              <h2
                className="text-gray-900 font-gilroy-bold"
                style={{ fontWeight: 400, fontSize: "clamp(28px, 5vw, 48px)", lineHeight: "1.1", letterSpacing: "-0.01em" }}
              >
        ...
        <div className="grid lg:grid-cols-[1fr_2fr] gap-4 sm:gap-6 mb-8 sm:mb-12">
          {/* LEFT ARTICLE CARD */}
          <div className="bg-white rounded-xl shadow-lg overflow-hidden w-full max-w-xs mx-auto lg:mx-0 flex flex-col" style={{ minHeight: "300px" }}>
            <div className="relative h-[100px] min-h-[100px]">
              <Image src="/images/dailyupdatescover.png" alt="Daily Updates Cover" fill className="object-cover" unoptimized />
            </div>

            <div className="p-3 sm:p-4 flex flex-col flex-1">
              <p className="text-xs sm:text-sm mb-1 text-[#BDBDBD]">03 October 2025</p>
              <h3 className="text-sm sm:text-base font-bold mb-2 text-[#737373]">
                Gulf markets end mixed on Ukraine ceasefire hopes, tariff fears
              </h3>
              <p className="text-gray-600 leading-relaxed text-xs mb-2 flex-1">
                Stock markets in the Gulf ended mixed on Wednesday, buoyed by Ukraine's readiness to support a proposal for...
              </p>
              <Link href={articleUrl} className="text-[var(--color-primary)] hover:underline font-medium text-xs">
                Read more
              </Link>
            </div>
          </div>
          ...
          <div className="relative w-full">
            {!isPlaying ? (
              ...
              <div className="relative w-full h-[250px] min-h-[250px] rounded-xl sm:rounded-[20px] overflow-hidden bg-black">
                {videoUrl && (
                  <ReactPlayer
                    url={videoUrl}
                    playing
                    ...
                    config={{ youtube: { playerVars: { autoplay: 1, controls: 1, modestbranding: 1 } } }}
                  />
                )}
              </div>
            )}
        ...
        {/* BOTTOM BANNER */}
        <div className="relative rounded-xl overflow-hidden shadow-2xl w-full min-h-[200px]">
          <div className="absolute inset-0">
            <Image src="/images/media bg-cover.png" alt="Media Background" fill className="object-cover" unoptimized />
          </div>

          <div className="absolute inset-0 z-10 p-4 sm:p-6 lg:p-8 flex items-center">
            <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 lg:gap-6 w-full items-center">
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-xs sm:text-sm md:text-base text-white leading-relaxed mb-3">
              ...
              <div className="flex justify-center lg:justify-end flex-shrink-0">
                <div className="relative w-20 h-[140px] sm:w-24 sm:h-[180px] lg:w-40 lg:h-[220px]"></div>
              </div>
            </div>
          </div>
        </div>
